...
import { SIDEBAR_WIDTH_MOBILE, type SidebarProps, useEditorLeftSidebar } from './editor-sidebars';
...
const { isMobile, openMobile, setOpenMobile, state } = useEditorLeftSidebar();
</script>
