...
import { SIDEBAR_WIDTH_MOBILE, type SidebarProps, useEditorRightSidebar } from './editor-sidebars';
...
const { isMobile, openMobile, setOpenMobile, state } = useEditorRightSidebar();
</script>
